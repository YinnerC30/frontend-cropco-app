...
//   it('Debe crear un crope', () => {
//     cy.getFormInput('first_name').type('CropName');
...
//   it('Modificar crope existente', () => {
//     cy.createCropAnd({}, ({ email, id }) => {
//       cy.visit(`/app/home/crops/view/all?query=${email}`);
//       cy.clickActionsButtonTableRow(id);
//       cy.get('button[data-testid="btn-update-record"]').click();
//       cy.getFormInput('first_name').clear().type('CropNameChanged');
...
//       cy.createCrop({ firstName: 'CropToRemoveBulk' }, { fastCreation: true });
//     }
//     cy.logoutUser();
//   });
...
//   // TODO: Implementar pruebas
//   // it('Intentar eliminar cultivos con ventas pendiente de pago', () => {});
...
// describe('Ver registro de crope', () => {
//   beforeEach(() => {
//     cy.loginUser();
//     cy.navigateToModuleWithSideBar('crops');
//   });

//   it('Ver registro de crope', () => {
//     cy.createCropAnd({}, ({ email, id }) => {
//       cy.openActionsMenuByField(
//         email,
//         `/app/home/crops/view/all?query=${email}`
...
// describe('Exportar cultivos a PDF', () => {
//   beforeEach(() => {
//     cy.loginUser();
//     cy.navigateToModuleWithSideBar('crops');
//   });

//   it('Generar certificado de crope', () => {
//     cy.wait(2000);
...
//         }
//       });
//     cy.get('button[data-testid="btn-export-all-crops"]').click();

//     cy.contains('Generando reporte...');
//     cy.contains('El reporte ha sido generado con éxito.');
//     const expectedFileName = `reporte-cultivos.pdf`;
...
//         cy.visit(`/app/home/crops/view/all?query=${cropData.email}`);
//         cy.wait(2000);
...
//         // Exportar cultivos
//         cy.get('button[data-testid="btn-export-all-crops"]').should(
//           'be.enabled'
//         );
...
//   it('Debe sacar al usuario si intenta crear un crope y no tiene permisos ', () => {
...
//   it('Debe sacar al usuario si intenta modificar a un crope y no tiene permisos', () => {
...
//   it('Debe sacar al usuario si intenta consultar a un crope y no tiene permisos', () => {
//     cy.createUser({ selectedActions: ['find_all_crops'] }).then((data: any) => {
//       cy.createCropAnd({}, (cropData) => {
