...
import { GetSupplier } from '../interfaces/Supplier';
...
export const columns: ColumnDef<GetSupplier>[] = [
  {
    id: 'actions',
    cell: ({ row }) => {
      const supplier = row.original;
      const { id } = supplier;
      const { deleteSupplierMutation } = useSupplierActions();
      const { mutate } = deleteSupplierMutation;
