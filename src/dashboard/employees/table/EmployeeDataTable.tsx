...
import { getUsers } from '@/dashboard/users/actions';
import { PlusIcon } from '@radix-ui/react-icons';
import { useQuery } from '@tanstack/react-query';
import { useNavigate, useSearchParams } from 'react-router-dom';
import { columns } from './ColumnsEmployee';
import { getEmployees } from '@/dashboard/employees/EmployeeMethods';
...
export const EmployeeDataTable = () => {
  ...
  const {
    ...
    queryKey: ['employees', parameter],
    queryFn: () => getEmployees({ parameter: parameter || '' }),
  });
