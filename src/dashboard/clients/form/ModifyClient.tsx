...
import { getClientById } from '@/dashboard/clients/ClientMethods';
...
export const ModifyClient = () => {
  const { id } = useParams();
  const { updateClientMutation } = useClientActions();
  const { mutate, isSuccess, isPending } = updateClientMutation;
