...
import {
  ...
  formSchemaSearchBarConsumption,
} from '@/modules/consumption/utils';
...
interface Props {
  ...
  >;
  onAddFilter: (
    filterName: keyof z.infer<typeof formSchemaSearchBarConsumption>
  ) => Promise<boolean>;
  onClearErrors: (
    filterName: keyof z.infer<typeof formSchemaSearchBarConsumption>
  ) => void;
...
export const ConsumptionSearchBarDateFilter: React.FC<Props> = (props) => {
