...
export function DataTableConsumptionDetail({
  data,
  columns,
  setSaleDetail,
      ...
      <div className="w-[600px]">
        <div className="flex flex-col items-start justify-between gap-2 my-2 ml-1">
          <Input
            ...
            value={
              (table.getColumn("supply_name")?.getFilterValue() as string) ?? ""
            }
            onChange={(event) =>
              table.getColumn("supply_name")?.setFilterValue(event.target.value)
            }
            className="max-w-sm"
          />
        </div>
