...
interface WorkSearchBarEmployeesFilterProps {
...
export const WorkSearchBarEmployeesFilter: React.FC<
  WorkSearchBarEmployeesFilterProps
> = ({
  formSearchBar,
  onAddFilter,
  onClearErrors,
        ...
        <FormField
          ...
          render={({ field }: { field: ControllerRenderProps<any, any> }) => (
            <FormItem className="">
              ...
              <FormDescription>
                {'Empleado(s) que han participado en el trabajo'}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
